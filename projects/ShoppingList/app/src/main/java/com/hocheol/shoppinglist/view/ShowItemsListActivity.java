package com.hocheol.shoppinglist.view;
...
import com.hocheol.shoppinglist.adapter.ItemsListAdapter;
import com.hocheol.shoppinglist.db.Items;
import com.hocheol.shoppinglist.viewmodel.ShowItemListActivityViewModel;
        ...
        viewModel.getItemListObserver().observe(this, new Observer<List<Items>>() {
            ...
            public void onChanged(List<Items> items) {
                if (items == null) {
                    ...
                    itemsListAdapter.setItemList(items);
